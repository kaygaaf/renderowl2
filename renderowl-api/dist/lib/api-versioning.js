...
export async function apiVersioningPlugin(fastify) {
...
// ============================================================================
export function shouldCompressResponse(request) {
...
export function matchETag(requestETag, currentETag) {
    if (!requestETag)
        return false;
...
export function createPaginatedResponse(data, total, pagination, baseUrl) {
