...
export class AnalyticsService {
  ...
  updateDailyStats(params: {
    ...
    `).run(
      ...
      params.userId,
      params.date,
      params.rendersTotal || 0,
      params.rendersCompleted || 0,
      params.rendersFailed || 0,
      params.rendersCancelled || 0,
      params.durationSeconds || 0,
      params.framesRendered || 0,
      params.creditsUsed || 0,
      params.storageBytes || 0
    );
  }
