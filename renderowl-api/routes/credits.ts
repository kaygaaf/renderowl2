 ...
 */
const hasInternalApiKey = (request: FastifyRequest): boolean => {
 ...
 */
const requireInternalAuth = (request: FastifyRequest, reply: FastifyReply): boolean => {
...
// ============================================================================
// Internal Credit Operations (for Automations team) - PROTECTED
// ============================================================================
